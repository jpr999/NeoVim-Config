...
vim.keymap.set("n", "<leader>sf", ":lua Snacks.dashboard.pick('files')<cr>", { desc = "Find files", silent = true })

vim.keymap.set(
	"n",
	"<leader>sg",
	":lua Snacks.dashboard.pick('live_grep')<cr>",
	{ desc = "Find string", silent = true }
)
